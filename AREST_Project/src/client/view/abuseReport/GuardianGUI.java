...
public class GuardianGUI extends JPanel implements CreateReportInterface, ViewReportInterface {
	...
	private JLabel phoneNumber = new JLabel("Telephone");
	...
	private final JFormattedTextField collContact1LastName = new JFormattedTextField();
	private final JFormattedTextField collContact2LastName = new JFormattedTextField();
	private final JFormattedTextField collContact3LastName = new JFormattedTextField();
	private final JFormattedTextField collContact4LastName = new JFormattedTextField();
	private final JFormattedTextField collContact5LastName = new JFormattedTextField();
	...
	public GuardianGUI() {
		...
		gbl_collateralContactsPanel.columnWidths = new int[]{0, 132, 0, 109, 0};
		gbl_collateralContactsPanel.rowHeights = new int[]{0, 0, 0, 0, 0, 0, 0, 0};
		gbl_collateralContactsPanel.columnWeights = new double[]{0.0, 0.0, 0.0, 0.0, Double.MIN_VALUE};
		...
		gbc_collContactLabel.gridwidth = 4;
		...
		collateralContactsPanel.add(lastNameLabel, gbc_lastNameLabel);
		
		
		GridBagConstraints gbc_phoneNumber = new GridBagConstraints();
		gbc_phoneNumber.weightx = 0.1;
		gbc_phoneNumber.insets = new Insets(0, 0, 5, 0);
		gbc_phoneNumber.gridx = 3;
		gbc_phoneNumber.gridy = 1;
		collateralContactsPanel.add(phoneNumber, gbc_phoneNumber);
		...
		filter.setupTextField(collContact2, DocumentSizeFilter.CHAR, 20);
		filter.setupTextField(collContact3, DocumentSizeFilter.CHAR, 20);
		filter.setupTextField(collContact4, DocumentSizeFilter.CHAR, 20);
		filter.setupTextField(collContact5, DocumentSizeFilter.CHAR, 20);
		filter.setupTextField(collContact1, DocumentSizeFilter.CHAR, 20);
		
		filter.setupTextField(collContact1LastName, DocumentSizeFilter.CHAR, 20);
		filter.setupTextField(collContact3LastName, DocumentSizeFilter.CHAR, 20);
		filter.setupTextField(collContact4LastName, DocumentSizeFilter.CHAR, 20);
		filter.setupTextField(collContact5LastName, DocumentSizeFilter.CHAR, 20);
		filter.setupTextField(collContact1LastName, DocumentSizeFilter.CHAR, 20);
		
		
		GridBagConstraints gbc_collContact1LastName = new GridBagConstraints();
		gbc_collContact1LastName.weightx = 0.3;
		gbc_collContact1LastName.insets = new Insets(0, 0, 5, 20);
		gbc_collContact1LastName.fill = GridBagConstraints.HORIZONTAL;
		gbc_collContact1LastName.gridx = 2;
		gbc_collContact1LastName.gridy = 2;
		collateralContactsPanel.add(collContact1LastName, gbc_collContact1LastName);
		...
		GridBagConstraints gbc_collContact2LastName = new GridBagConstraints();
		gbc_collContact2LastName.insets = new Insets(0, 0, 5, 20);
		gbc_collContact2LastName.fill = GridBagConstraints.HORIZONTAL;
		gbc_collContact2LastName.gridx = 2;
		gbc_collContact2LastName.gridy = 3;
		collateralContactsPanel.add(collContact2LastName, gbc_collContact2LastName);
		...
		GridBagConstraints gbc_collContact3LastName = new GridBagConstraints();
		gbc_collContact3LastName.insets = new Insets(0, 0, 5, 20);
		gbc_collContact3LastName.fill = GridBagConstraints.HORIZONTAL;
		gbc_collContact3LastName.gridx = 2;
		gbc_collContact3LastName.gridy = 4;
		collateralContactsPanel.add(collContact3LastName, gbc_collContact3LastName);
		...
		GridBagConstraints gbc_collContact4LastName = new GridBagConstraints();
		gbc_collContact4LastName.insets = new Insets(0, 0, 5, 20);
		gbc_collContact4LastName.fill = GridBagConstraints.HORIZONTAL;
		gbc_collContact4LastName.gridx = 2;
		gbc_collContact4LastName.gridy = 5;
		collateralContactsPanel.add(collContact4LastName, gbc_collContact4LastName);
		...
		gbc_collContact5.insets = new Insets(0, 0, 5, 20);
		collateralContactsPanel.add(collContact5, gbc_collContact5);
		
		GridBagConstraints gbc_collContact5LastName = new GridBagConstraints();
		gbc_collContact5LastName.insets = new Insets(0, 0, 5, 20);
		gbc_collContact5LastName.fill = GridBagConstraints.HORIZONTAL;
		gbc_collContact5LastName.gridx = 2;
		gbc_collContact5LastName.gridy = 6;
		collateralContactsPanel.add(collContact5LastName, gbc_collContact5LastName);
		
		GridBagConstraints gbc_cc5PhonePanel = new GridBagConstraints();
		gbc_cc5PhonePanel.fill = GridBagConstraints.BOTH;
		gbc_cc5PhonePanel.gridx = 3;
		...
		gbc_allegedAbuseDescriptionNotSetWarning.anchor = GridBagConstraints.SOUTH;
		...
		gbc_riskNotSetWarning.anchor = GridBagConstraints.SOUTH;
	...
	public Report updateReport(Report report, boolean redacted) {
		...
		PersonInfo cContact1 = new PersonInfo();
		cContact1.setFirstName(collContact1.getText());
		cContact1.setLastName(collContact1LastName.getText());
		cContact1.setPhoneNumber(cc1PhoneAreaCode.getText().concat(cc1PhoneFirstThree.getText().concat(cc1PhoneLastFour.getText())));
		
		PersonInfo cContact2 = new PersonInfo();
		cContact2.setFirstName(collContact2.getText());
		cContact2.setLastName(collContact2LastName.getText());
		cContact2.setPhoneNumber(cc2PhoneAreaCode.getText().concat(cc2PhoneFirstThree.getText().concat(cc2PhoneLastFour.getText())));
		
		PersonInfo cContact3 = new PersonInfo();
		cContact3.setFirstName(collContact3.getText());
		cContact3.setLastName(collContact3LastName.getText());
		cContact3.setPhoneNumber(cc3PhoneAreaCode.getText().concat(cc3PhoneFirstThree.getText().concat(cc3PhoneLastFour.getText())));
		
		PersonInfo cContact4 = new PersonInfo();
		cContact4.setFirstName(collContact4.getText());
		cContact4.setLastName(collContact4LastName.getText());
		cContact4.setPhoneNumber(cc4PhoneAreaCode.getText().concat(cc4PhoneFirstThree.getText().concat(cc4PhoneLastFour.getText())));
		
		PersonInfo cContact5 = new PersonInfo();
		cContact5.setFirstName(collContact5.getText());
		cContact5.setLastName(collContact5LastName.getText());
		cContact5.setPhoneNumber(cc5PhoneAreaCode.getText().concat(cc5PhoneFirstThree.getText().concat(cc5PhoneLastFour.getText())));
	...
	public void updatePanel(Report report, boolean redacted) {
		...
		if(report.guardian.getFirstName() != null) {
			guardFirstName.setText(report.guardian.getFirstName());
		}
		if(report.guardian.getLastName() != null) {
			guardLastName.setText(report.guardian.getLastName());
		}
		if(report.guardian.getAddress() != null) {
			guardianAddress.setText(report.guardian.getAddress());
		}
		if(report.guardian.getRelationshipToVictim() != null) {
			guardRelationship.setText(report.guardian.getRelationshipToVictim());
		}
		if(report.guardian.getPhoneNumber() != null) {
			guardPhoneAreaCode.setText(report.guardian.getPhoneNumber().substring(0, 3));
			guardPhoneFirstThree.setText(report.guardian.getPhoneNumber().substring(3, 6));
			guardPhoneLastFour.setText(report.guardian.getPhoneNumber().substring(6, 10));
		}
		

		if(!report.collateralContact1.getFirstName().equals("")) {
			collContact1.setText(report.collateralContact1.getFirstName());
		}
		if(!report.collateralContact2.getFirstName().equals("")) {
			collContact2.setText(report.collateralContact2.getFirstName());
		}
		if(!report.collateralContact3.getFirstName().equals("")) {
			collContact3.setText(report.collateralContact3.getFirstName());
		}
		if(!report.collateralContact4.getFirstName().equals("")) {
			collContact4.setText(report.collateralContact4.getFirstName());
		}
		if(!report.collateralContact5.getFirstName().equals("")) {
			collContact5.setText(report.collateralContact5.getFirstName());
		}
		if(!report.collateralContact1.getLastName().equals("")) {
			collContact1LastName.setText(report.collateralContact1.getLastName());
		}
		if(!report.collateralContact2.getLastName().equals("")) {
			collContact2LastName.setText(report.collateralContact2.getLastName());
		}
		if(!report.collateralContact3.getLastName().equals("")) {
			collContact3LastName.setText(report.collateralContact3.getLastName());
		}
		if(!report.collateralContact4.getLastName().equals("")) {
			collContact4LastName.setText(report.collateralContact4.getLastName());
		}
		if(!report.collateralContact5.getLastName().equals("")) {
			collContact5LastName.setText(report.collateralContact5.getLastName());
		}
		if(!report.collateralContact1.getPhoneNumber().equals("")) {
			cc1PhoneAreaCode.setText(report.collateralContact1.getPhoneNumber().substring(0, 3));
		}
		if(!report.collateralContact2.getPhoneNumber().equals("")) {
			cc2PhoneAreaCode.setText(report.collateralContact2.getPhoneNumber().substring(0, 3));
		}
		if(!report.collateralContact3.getPhoneNumber().equals("")) {
			cc3PhoneAreaCode.setText(report.collateralContact3.getPhoneNumber().substring(0, 3));
		}
		if(!report.collateralContact4.getPhoneNumber().equals("")) {
			cc4PhoneAreaCode.setText(report.collateralContact4.getPhoneNumber().substring(0, 3));
		}
		if(!report.collateralContact5.getPhoneNumber().equals("")) {
			cc5PhoneAreaCode.setText(report.collateralContact5.getPhoneNumber().substring(0, 3));
		}
		if(!report.collateralContact1.getPhoneNumber().equals("")) {
			cc1PhoneFirstThree.setText(report.collateralContact1.getPhoneNumber().substring(3, 6));
		}
		if(!report.collateralContact2.getPhoneNumber().equals("")) {
			cc2PhoneFirstThree.setText(report.collateralContact2.getPhoneNumber().substring(3, 6));
		}
		if(!report.collateralContact3.getPhoneNumber().equals("")) {
			cc3PhoneFirstThree.setText(report.collateralContact3.getPhoneNumber().substring(3, 6));
		}
		if(!report.collateralContact4.getPhoneNumber().equals("")) {
			cc4PhoneFirstThree.setText(report.collateralContact4.getPhoneNumber().substring(3, 6));
		}
		if(!report.collateralContact5.getPhoneNumber().equals("")) {
			cc5PhoneFirstThree.setText(report.collateralContact5.getPhoneNumber().substring(3, 6));
		}
		if(!report.collateralContact1.getPhoneNumber().equals("")) {
			cc1PhoneLastFour.setText(report.collateralContact1.getPhoneNumber().substring(6, 10));
		}
		if(!report.collateralContact2.getPhoneNumber().equals("")) {
			cc2PhoneLastFour.setText(report.collateralContact2.getPhoneNumber().substring(6, 10));
		}
		if(!report.collateralContact3.getPhoneNumber().equals("")) {
			cc3PhoneLastFour.setText(report.collateralContact3.getPhoneNumber().substring(6, 10));
		}
		if(!report.collateralContact4.getPhoneNumber().equals("")) {
			cc4PhoneLastFour.setText(report.collateralContact4.getPhoneNumber().substring(6, 10));
		}
		if(!report.collateralContact5.getPhoneNumber().equals("")) {
			cc5PhoneLastFour.setText(report.collateralContact5.getPhoneNumber().substring(6, 10));
		}
		
		
		allegedAbuseDescriptionText.setText(report.getAbuseDescr());
		riskText.setText(report.getVictimRisk());
