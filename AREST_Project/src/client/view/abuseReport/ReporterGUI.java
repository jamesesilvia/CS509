...
public class ReporterGUI extends ArestPanel implements CreateReportInterface, ViewReportInterface {
	...
	public boolean isAbuserPanelValid() {
		...
		if(!socAreaNumber.getText().equals("REDACTED")) {	
	...
	public boolean isReporterPanelValid() {
		...
		if(!phoneFirstThree.getText().equals("REDACTED")) {
	...
	public void updatePanel(Report report, boolean redacted) {
		Font redactionFont = new Font("Verdana", Font.BOLD, 13);
		
		// Configure the reporter fields.
		firstNameTextField.setText(report.reporter.getFirstName());
		if(redacted) {
			firstNameTextField.setFont(redactionFont);
			firstNameTextField.setForeground(Color.RED);
			firstNameTextField.setEditable(false);
			firstNameTextField.setText("REDACTED");
		}
		
		lastNameTextField.setText(report.reporter.getLastName());
		if(redacted) {
			lastNameTextField.setFont(redactionFont);
			lastNameTextField.setForeground(Color.RED);
			lastNameTextField.setEditable(false);
			lastNameTextField.setText("REDACTED");
		}
		
		addrTextArea.setText(report.reporter.getAddress());
		if(redacted) {
			addrTextArea.setFont(redactionFont);
			addrTextArea.setForeground(Color.RED);
			addrTextArea.setEditable(false);
			addrTextArea.setText("REDACTED");
			addrTextArea.setOpaque(false);
		}
		...
		if(redacted) {
			filter.setupTextField(phoneAreaCode, DocumentSizeFilter.CHAR, 8);
			phoneAreaCode.setForeground(Color.RED);
			phoneAreaCode.setFont(redactionFont);
			phoneAreaCode.setText(report.reporter.getPhoneNumber());
			phoneAreaCode.setEditable(false);
			phoneAreaCode.setText("REDACTED");
		} else {
			phoneAreaCode.setText(report.reporter.getPhoneNumber().substring(0, 3));
		}
		
		if(redacted) {
			filter.setupTextField(phoneFirstThree, DocumentSizeFilter.CHAR, 8);
			phoneFirstThree.setForeground(Color.RED);
			phoneFirstThree.setFont(redactionFont);
			phoneFirstThree.setText(report.reporter.getPhoneNumber());
			phoneFirstThree.setEditable(false);
			phoneFirstThree.setText("REDACTED");
		} else {
			phoneFirstThree.setText(report.reporter.getPhoneNumber().substring(3, 6));
		}
		
		if(redacted) {
			filter.setupTextField(phoneLastFour, DocumentSizeFilter.CHAR, 8);
			phoneLastFour.setForeground(Color.RED);
			phoneLastFour.setFont(redactionFont);
			phoneLastFour.setText(report.reporter.getPhoneNumber());
			phoneLastFour.setEditable(false);
			phoneLastFour.setText("REDACTED");
		} else {
		...
		if(redacted){
			abuserFirstName.setFont(redactionFont);
			abuserFirstName.setForeground(Color.RED);
			abuserFirstName.setEditable(false);
			abuserFirstName.setText("REDACTED");
		}
		
		abuserLastName.setText(report.abuser.getLastName());
		if(redacted) {
			abuserLastName.setFont(redactionFont);
			abuserLastName.setForeground(Color.RED);
			abuserLastName.setEditable(false);
			abuserLastName.setText("REDACTED");
		}
		
		abuserAddress.setText(report.abuser.getAddress());
		if(redacted) {
			abuserAddress.setFont(redactionFont);
			abuserAddress.setForeground(Color.RED);
			abuserAddress.setEditable(false);
			abuserAddress.setOpaque(false);
			abuserAddress.setText("REDACTED");
		}
		
		abuserRelationship.setText(report.abuser.getRelationshipToVictim());
		
		//socAreaNumber.setText(report.abuser.getSocial());
		if(redacted) {
			filter.setupTextField(socAreaNumber, DocumentSizeFilter.CHAR, 8);
			socAreaNumber.setFont(redactionFont);
			socAreaNumber.setForeground(Color.RED);
			socAreaNumber.setEditable(false);
			socAreaNumber.setText("REDACTED");
		} else {
			socAreaNumber.setText(report.abuser.getSocial().substring(0, 3));
		}
		
		//socGroupNum.setText(report.abuser.getSocial());
		if(redacted) {
			filter.setupTextField(socGroupNum, DocumentSizeFilter.CHAR, 8);
			socGroupNum.setFont(redactionFont);
			socGroupNum.setForeground(Color.RED);
			socGroupNum.setEditable(false);
			socGroupNum.setText("REDACTED");
		} else {
			socGroupNum.setText(report.abuser.getSocial().substring(3, 5));
		}
		
		//socSerialNum.setText(report.abuser.getSocial());
		if(redacted) {
			filter.setupTextField(socSerialNum, DocumentSizeFilter.CHAR, 8);
			socSerialNum.setFont(redactionFont);
			socSerialNum.setForeground(Color.RED);
			socSerialNum.setEditable(false);
			socSerialNum.setText("REDACTED");
		} else {
